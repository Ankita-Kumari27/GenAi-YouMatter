...
const Auth = () => {
  ...
  const [guardianEmail, setGuardianEmail] = useState(""); // ✅ NEW
  ...
  return (
    <div className="min-h-screen cloud-bg flex items-center justify-center p-4 relative">
      <div className="glass-card-strong rounded-3xl p-8 max-w-md w-full relative z-10 animate-fade-in">
        <Link
          to="/"
          className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-primary mb-6 font-body"
        >
